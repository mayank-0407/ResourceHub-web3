...
urlpatterns = [
    ...
    path('dashboard/pricing/basic/', views.isbasic,name="isbasic"),
    path('dashboard/pricing/premium/', views.ispremium,name="ispremium"),
    path('dashboard/pricing/add/', views.Add_key,name="Add_key"),
