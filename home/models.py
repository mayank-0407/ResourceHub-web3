...
class Customer(models.Model):
    ...
    is_basic=models.BooleanField(default=False,null=True,blank=True)
    is_premium=models.BooleanField(default=False,null=True,blank=True)
    meta_key=models.TextField(max_length=100,null=True,blank=True)
    walletkey=models.TextField(max_length=100,null=True,blank=True)
